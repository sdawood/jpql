...
function eval_recurse(partial, component, operation, scope, handler, contextManager) {
  ...
  if (handler === undefined) {
    ...
    /* poorman's implementatio of bootstrap provider scripts, badly needed to build the require provide feature */
    if(component.expression.active.provider) { //event value_ready from script handler
