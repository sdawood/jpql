...
Handlers.prototype._fns = {
  ...
  'member-child-identifier': function(component, partial, contextManager) {
    ...
    if (value instanceof Object && key in value) {
      ...
      if (component.branch) {
        nodeContext = contextManager.push({$branch: partial, $edge: partial, $rel: partial}, 'member-child-identifier');
        results = handleBranch(component, results, contextManager);
      }
      return results;
    }
    return [];
  ...
  'subscript-child-slice': function(component, partial, contextManager) {
    ...
    if (is_array(partial.value)) {
      ...
      if (component.branch) {
        nodeContext = contextManager.push({$branch: partial, $edge: partial, $rel: partial}, 'subscript-child-slice');
        results = handleBranch(component, nodes, contextManager);
  ...
  'subscript-child-slice|active': function(component, partial, contextManager) {
    ...
    if (is_array(partial.value)) {
      ...
      if (component.branch) {
        nodeContext = contextManager.push({$branch: partial, $edge: partial, $rel: partial}, 'subscript-child-slice|active');
        results = handleBranch(component, nodes, contextManager);
  ...
  'subscript-child-filter_expression': function(component, partial, contextManager) {
    ...
    var passable = function(key, value) {
      ...
      console.log('subscript-child-filter::', _pass, key, "->", value, '$leaf::', value, '$parent::', nodeContext.$parent);
      return _pass;
    };
    ...
    if (component.branch) {
      nodeContext = contextManager.push({$branch: partial, $edge: partial, $rel: partial}, 'subscript-child-filter_expression');
      results = handleBranch(component, results, contextManager);
    }
    return results;
  },
  ...
  'subscript-descendant-filter_expression': function(component, partial, contextManager) {
    ...
    var passable = function(key, value) {
      ...
      console.log('subscript-descendant-filter::', _pass, key, "->", value, '$leaf::', value, '$parent::', nodeContext.$parent);
      return _pass;
    }
    ...
    console.log('nodeContext$parent::', debug_inspect(nodeContext.$parent));
    if (component.branch) {
      nodeContext = contextManager.push({$branch: partial, $edge: partial, $rel: partial}, 'subscript-descendant-filter_expression');
      results = handleBranch(component, results, contextManager);
    }
    return results;
  },
  ...
  'subscript-child-root': function(component, partial, contextManager) {
    ...
    console.log('nodeContext$parent::', debug_inspect(nodeContext.$parent));
    if (component.branch) {
      nodeContext = contextManager.push({$branch: partial, $edge: partial, $rel: partial}, 'subscript-child-root');
      results = handleBranch(component, [ results ], contextManager);
    }
...
function scriptComponentHandler(operation, scope, handler) {
  ...
  return function (component, partial, contextManager) {
    ...
    console.log('nodeContext$parent::', debug_inspect(nodeContext.$parent));
    if (component.branch) {
      nodeContext = contextManager.push({$branch: partial, $edge: partial, $rel: partial}, 'scriptComponentHandler', handler);
      results = handleBranch(component, results, contextManager);
    }
    return results;
  }
...
function evalScript(partial, script, contextManager) {
  ...
  console.log('evalScript', 'script::', script, '$leaf::', partial.value, 'value::', value, '$parent::', nodeContext.$parent);
  return value;
}
...
function evalActiveScript(partial, script, contextManager) {
  ...
  var value = evaluate(ast, {
    ...
    '$node': nodeContext.$parent ? nodeContext.$parent.value : undefined,
    '$': nodeContext.$root.value,
    '$quoteAll': nodeContext.$quoteAll
  });
  console.log('evalActiveScript', 'script::', script, '$leaf::', partial.value, 'value::', value, '$parent::', nodeContext.$parent);
  return value;
}
...
function _descend(passable) {
  return function(component, partial, contextManager) {
    ...
    console.log('nodeContext$parent::', debug_inspect(nodeContext.$parent));
    if (component.branch) {
      nodeContext = contextManager.push({$branch: partial, $edge: partial, $rel: partial}, 'descend');
      results = handleBranch(component, nodes, contextManager);
...
function _traverse(passable) {
  return function(component, partial, contextManager) {
    ...
    console.log('nodeContext$parent::', debug_inspect(nodeContext.$parent));
    if (component.branch) {
      nodeContext = contextManager.push({$branch: partial, $edge: partial, $rel: partial}, 'traverse');
      results = handleBranch(component, nodes, contextManager);
