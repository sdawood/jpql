...
//      key = '$key', //which key was current value '@' under
//      parent = '$parent', //immediate parent value, handy after expansions
//      parentKey = '$parentKey', //immediate parent value, handy in expansions
//      branch = '$branch', //first node in the branch, a child of $node, anchor
//      node = '$node', //node before branch or expansion, anchor
//      root = '$'; //$stem $root, anchor
    switch (link) {
      case	'.@':
      case	'.#':
      case	'.@@':
