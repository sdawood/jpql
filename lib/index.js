...
JSONPath.prototype.nodes = function(obj, string, options) {
  ...
  console.log(util.inspect(path, false, null));
  ...
  options.$root = obj;
  options.$parent = obj;
  return this.pathNodes(partials, path, options);
};

JSONPath.prototype.pathNodes = function(partials, path, options) {
  options = options || {};
  ...
  path.forEach(function(component, index) {
    ...
    partials.forEach(function(p) {
      var results = [];
      if (options.relative) {
        results = handler(component, { path: ['$'], value: p.value }, { $root: options.$root, $parent: options.$parent});
