...
JSONPath.prototype.configure = function (options, meta, contextManager) {
  this.contextManager = contextManager ? contextManager.configure(options, meta) :
    this.contextManager ? this.contextManager.configure(options, meta) :
      new this.ContextManager(options, meta, this);
  return this;
}

JSONPath.prototype.nodes = function(source, path, contextManager) {
  contextManager = contextManager || this.contextManager || new this.ContextManager(null, {location: '$'}, this); //legacy interpreter should have the contextManager injected and not instantiate one on its own discretion, jpql is passed as reader
