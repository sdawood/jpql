...
/*INDEA
  ...
  * as a candidate for evaluation-feature, a simple dry run that generates a scafolding object to hold the data
   ...
   * the dry run, if passed a reference to the object, is capable of taking the object along for the ride, effectively visiting the shortest path stree in the graph
