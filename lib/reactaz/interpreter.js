 ...
 * Note identical role of:
 ...
 ResourceNode[$key, $parent, $branch, $node, $root] (Note how ResourceNode has a double role, since it is the same node retreiver from head() loaded with parent scope chain) and the this reference, below
  === variableObject
 ResourceNode === this
